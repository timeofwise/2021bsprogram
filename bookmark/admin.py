...
class ReportAdmin(admin.ModelAdmin):
    list_display = ['id', 'client', 'item', 'mini_title_or_main_product', 'desc', 'img', 'target_goods', 'target_goods_price', 'target_goods_qty']
    list_editable = ['client', 'item', 'mini_title_or_main_product', 'desc', 'img']
