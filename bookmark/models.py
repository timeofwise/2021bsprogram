...
class Consumed(models.Model):
    ...
    part_img = models.ImageField(upload_to='img/', default='photos/no_image.png', null=True)
...
class Report(models.Model):
    ...
    img2_alt = models.CharField(max_length=50, null=True, default='caption2')
    img3 = models.ImageField(upload_to='img/report', default='photos/no_image.png', null=True)
    img3_alt = models.CharField(max_length=50, null=True, default='caption3')
